...
function paperRequirements(firstBookQuantity, secondBookQuantity, thirdBookQuantity) {
    ...
    const firstBookTotalPaper = firstBookPaper * firstBookQuantity;
    const secondBookTotalPaper = secondBookPaper * secondBookQuantity;
    const thirdBookTotalPaper = thirdBookPaper * thirdBookQuantity;

    const overAllpaperNeed = firstBookTotalPaper + secondBookTotalPaper + thirdBookTotalPaper;
    return overAllpaperNeed;

}

const result = paperRequirements(2, 5, 3);
console.log(result);